...
class NotificationExplorer extends StatefulWidget {
  final String type;

  const NotificationExplorer({Key? key, required this.type}) : super(key: key);

  @override
  State<NotificationExplorer> createState() => _NotificationExplorerState();
}

class _NotificationExplorerState extends State<NotificationExplorer> {
